...
public class Challenges implements Serializable {
	...
	public Challenges(int idChallenge, String titre, String description, Date datedebut, Date datefin, int nbreplaces) {
	...
	public Challenges(String titre, String description, Date datedebut, Date datefin,
	...
	public Challenges(TypeChallenge typeChallenge,byte[] picture,Category category ,String titre, String description,Integer nbrplace, Date datedebut, Date datefin) {
	...
	public Challenges(Category category,String titre, String description, Date datedebut, Date datefin,
